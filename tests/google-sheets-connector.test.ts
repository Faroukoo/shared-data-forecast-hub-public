...
const REDIRECT_URL =
  "https://doc-xx-a8-sheets.googleusercontent.com/export/download.xlsx";
...
void test("rejects Google redirect host suffix and sibling tricks", async () => {
  const rejectedLocations = [
    ...
    "https://doc-xx.sheets-googleusercontent.com/file.xlsx",
    "https://doc-xx-a8-sheets.googleusercontent.com.evil.invalid/file.xlsx",
  ];
...
void test("rejects redirect credentials and HTTP before the next transport", async () => {
  const rejectedLocations = [
    "https://user:secret@doc-xx-a8-sheets.googleusercontent.com/file.xlsx",
    "http://doc-xx-a8-sheets.googleusercontent.com/file.xlsx",
  ];
